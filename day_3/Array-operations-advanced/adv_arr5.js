// ADVANCED ASSIGNMENT 5: transaction processing with filter, map, reduce, find, and findIndex
let transactions = [
...
// 1. Filter credit transactions only
const credit = transactions.filter((txn) => txn.type === "credit")
console.log(credit)

// 2. Map to extract only the transaction amounts
const Amounts = transactions.map((txn) => txn.amount)
console.log(Amounts)

// 3. Reduce to compute the final account balance
...
// 4. Find the first debit transaction in the list
